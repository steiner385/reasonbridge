...
Build #35+ will automatically:
1. Apply Prisma migrations to E2E database
2. Seed test data before running Playwright tests
3. Execute all 301 E2E tests with proper configuration
