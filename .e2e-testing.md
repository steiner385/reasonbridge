...
DATABASE_URL="postgresql://reasonbridge_test:reasonbridge_test@localhost:5434/reasonbridge_test" npx prisma migrate deploy
DATABASE_URL="postgresql://reasonbridge_test:reasonbridge_test@localhost:5434/reasonbridge_test" node prisma/seed.js
```
...
**Note:** Jenkins loads pipeline from reasonbridge-lib@main via the stub Jenkinsfile.
Container names use 'reasonbridge-\*-e2e' pattern matching docker-compose.e2e.yml.
