...
function Typography({
  ...
  const variantClasses = {
    article: `
      prose prose-lg
      prose-headings:font-bold prose-headings:text-gray-900 dark:text-gray-100 dark:prose-headings:text-gray-100
      ...
      prose-strong:text-gray-900 dark:text-gray-100 dark:prose-strong:text-gray-100 prose-strong:font-semibold
      ...
      prose-li:mb-2
      prose-blockquote:border-l-4 prose-blockquote:border-primary-500 prose-blockquote:pl-4 prose-blockquote:italic prose-blockquote:text-gray-600 dark:text-gray-400 dark:prose-blockquote:text-gray-400
    `,
    comment: `
      prose prose-sm
      prose-p:mb-2 prose-p:leading-relaxed
      prose-a:text-primary-600 dark:prose-a:text-primary-400 prose-a:no-underline hover:prose-a:underline
      prose-strong:text-gray-900 dark:text-gray-100 dark:prose-strong:text-gray-100 prose-strong:font-medium
