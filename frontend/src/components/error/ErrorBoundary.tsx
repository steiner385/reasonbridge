...
class ErrorBoundary extends Component<ErrorBoundaryProps, ErrorBoundaryState> {
  ...
  override render(): ReactNode {
    if (this.state.hasError) {
      ...
      // Default fallback UI
      return (
        <div className="min-h-screen flex items-center justify-center p-2 sm:p-4 bg-gray-50 dark:bg-gray-900">
          <Card variant="elevated" padding="lg" className="max-w-2xl w-full">
            <div className="text-center">
              ...
              <div className="mx-auto flex items-center justify-center h-12 w-12 sm:h-16 sm:w-16 rounded-full bg-red-100 dark:bg-red-900/20 mb-3 sm:mb-4">
                <svg
                  className="h-8 w-8 sm:h-10 sm:w-10 text-red-700 dark:text-red-400"
                  fill="none"
                  stroke="currentColor"
                  viewBox="0 0 24 24"
                  aria-hidden="true"
              ...
              {import.meta.env.DEV && this.state.error && (
                <details className="mb-4 sm:mb-6 text-left">
                  ...
                  <div className="bg-gray-100 dark:bg-gray-800 rounded-lg p-2 sm:p-4 overflow-auto max-h-48 sm:max-h-64">
