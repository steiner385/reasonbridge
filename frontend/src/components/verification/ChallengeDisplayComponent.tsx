...
const ChallengeDisplayComponent: React.FC<ChallengeDisplayComponentProps> = ({
  ...
  const renderChallengeContent = () => {
    switch (challenge.type) {
      case VideoChallengeType.RANDOM_PHRASE:
        return (
          <div className="space-y-4">
            <p className="text-gray-700 dark:text-gray-300 mb-4">{challenge.instruction}</p>
          ...
          <div className="space-y-4">
            ...
            {challenge.randomValue && (
              <div className="p-4 bg-green-50 border-2 border-green-300 rounded-lg">
                <p className="text-sm text-gray-600 dark:text-gray-400 mb-2">Action to perform:</p>
          ...
          <div className="space-y-4">
            ...
            {challenge.timestamp && (
              <div className="p-4 bg-purple-50 border-2 border-purple-300 rounded-lg">
                <p className="text-sm text-gray-600 dark:text-gray-400 mb-2">Current timestamp:</p>
      ...
      default:
        return <p className="text-gray-700 dark:text-gray-300">{challenge.instruction}</p>;
    }
  };
