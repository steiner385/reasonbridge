...
export const DEMO_USER_IDS = {
  ...
  UNVERIFIED_UMA: '11111111-0000-4000-8000-000000000006',
} as const;
...
export const DEMO_TOPIC_IDS = {
  ...
  RENEWABLE_ENERGY_MANDATE: '11111111-0000-4000-8000-000000000111', // SEEDING status
  UNIVERSAL_BASIC_INCOME: '11111111-0000-4000-8000-000000000112', // LOCKED status
} as const;
