...
describe('CommonGroundExportService', () => {
  ...
  describe('exportAnalysis', () => {
    it('should throw error for unsupported format', async () => {
      ...
      await expect(service.exportAnalysis(analysis, 'xml' as any)).rejects.toThrow(
  ...
  describe('exportToMarkdown', () => {
    ...
    it('should include agreement zones section', async () => {
      ...
      expect(markdown).toContain(
        'Most participants agree that climate change requires urgent action',
      );
    ...
    it('should include footer with attribution', async () => {
      ...
      expect(markdown).toContain('*Generated by ReasonBridge Common Ground Analysis*');
    });
  });
