 ...
 *
 * NOTE: These tests require DATABASE_URL to be set with valid credentials.
 * They are skipped in local unit test phase and run during integration
 * test phase when Docker database is available.
 */
describe.skipIf(!process.env['DATABASE_URL'] || !process.env['CI'])(
