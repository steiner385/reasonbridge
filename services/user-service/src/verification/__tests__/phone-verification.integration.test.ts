 ...
 * AND INTEGRATION_TEST_DB_READY=true (set by CI after database is confirmed available).
 * This ensures tests only run when the database is actually accessible.
 */
